export namespace WEBAUDIO {
     ...
     */
    function createAudioInPort(op: typeof import("./core_op.js").Op, portName: string, audioNode: AudioNode, inputChannelIndex?: number): typeof import("./core_port.js").Port | undefined;
    /**
     ...
     */
    function createAudioOutPort(op: CABLES.op, portName: string, audioNode: AudioNode): (typeof import("./core_port.js").Port | undefined);
    /**
     ...
     */
    function createAudioParamInPort(op: typeof import("./core_op.js").Op, portName: string, audioNode: any, options: any, defaultValue: any): (typeof import("./core_port.js").Port | undefined);
    /**
